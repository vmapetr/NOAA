...
namespace NOAA.Database
{
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<EditedEvents>().ToTable("EditedEvents");
            ...
            //modelBuilder.Entity<OvationAuroraLatest>().ToTable("OvationAuroraLatest");
        ...
        //public DbSet<OvationAuroraLatest> OvationAuroraLatest { get; set; }
        ...
        //public DbSet<SolarRegions> SolarRegions { get; set; }
